...
DISTDIR = /home/dirbuster/Tp_Pong/TPpong/.tmp/TPpong1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MainWindow.h MyScene.h MyView.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp MainWindow.cpp MyScene.cpp MyView.cpp $(DISTDIR)/
